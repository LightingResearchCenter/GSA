...
area1 = area(axes1,time,activity);
set(area1,'FaceColor',[.2 .2 .2],'EdgeColor',[.2 .2 .2],'DisplayName','Activity');
plot1 = plot(axes1,time,CS);
set(plot1,'Color',[.6 .6 .6],'LineWidth',1,'DisplayName','Circadian Stimulus');
datetick2;
