function batchhourlyportlandworkday
%BATCHHOURLYPORTLANDWORKDAY Summary of this function goes here
...
outputExcelPath = fullfile(resultsDir,['hourlyAverageWorkDay_',datestr(now,'yyyy-mm-dd_HH-MM'),'.xlsx']);
outputMatPath = fullfile(resultsDir,'hourlyAverageWorkDay.mat');
...
for i1 = 1:nFile
    ...
    % Crop data to work day
    Daysimeter = workdaycrop(Daysimeter);
