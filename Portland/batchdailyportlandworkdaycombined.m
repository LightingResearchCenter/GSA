function batchdailyportlandworkdaycombined
%BATCHDAILYPORTLANDWORKDAYCOMBINED Summary of this function goes here
...
outputExcelPath = fullfile(resultsDir,['dailyAverageWorkDayCombined_',datestr(now,'yyyy-mm-dd_HH-MM'),'.xlsx']);
outputMatPath = fullfile(resultsDir,'dailyAverageWorkDayCombined.mat');
...
for i1 = 1:nEntries
    dailyData(i1,1) = dailyaveragealldays(hourlyData(i1));
