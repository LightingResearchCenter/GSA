function cloudysunnyaverages
%CLOUDYSUNNYAVERAGES Summary of this function goes here
...
inputPath = fullfile(resultsDir,'dailyAverage.mat');
outputExcelPath = fullfile(resultsDir,['cloudySunnyAverage_',datestr(now,'yyyy-mm-dd_HH-MM'),'.xlsx']);
outputMatPath = fullfile(resultsDir,'cloudySunnyAverage.mat');
