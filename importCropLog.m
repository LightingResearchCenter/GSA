function [subject,startTime,stopTime] = importCropLog(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE Import data from a spreadsheet
%   [subject,startTime,stopTime] = IMPORTFILE(FILE) reads data from the
%   first worksheet in the Microsoft Excel spreadsheet file named FILE and
%   returns the data as column vectors.
%
%   [subject,startTime,stopTime] = IMPORTFILE(FILE,SHEET) reads from the
%   specified worksheet.
%
%   [subject,startTime,stopTime] = IMPORTFILE(FILE,SHEET,STARTROW,ENDROW)
...
%
% Example:
%   [subject,startTime,stopTime] = importfile('cropLog.xlsx','Cropped
%   Daysimeter Time',2,12);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2014/02/14 15:39:53
